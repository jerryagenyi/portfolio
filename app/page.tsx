    ...
    <main>
      ...
      <section id="jobs" style={{ maxWidth: '900px', margin: '0 auto', padding: '100px 50px' }}>
        ...
        <div style={{ marginBottom: '50px' }}>
          <div style={{ color: 'var(--lightest-slate)', fontWeight: 600 }}>Lead Engineer</div>
          <a href="https://www.upstatement.com/" target="_blank" rel="noreferrer" style={{ color: 'var(--green)', textDecoration: 'none' }}>Upstatement</a>
          <div style={{ color: 'var(--slate)', fontSize: '14px' }}>May 2018 - Present</div>
        </div>
      </section>
